class ShoppingsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to shoppings_path, status: :see_other, notice: "Shopping was successfully destroyed." }
  ...
  private
    ...
    def set_shopping
      @shopping = Shopping.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def shopping_params
      params.expect(shopping: [ :product_id, :room_id, :first_name, :last_name ])
    end
end
